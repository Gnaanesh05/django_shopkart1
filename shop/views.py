...
def home(request):
    ...
    return render(request, "shop\index1.html", {"products": products})
...
'''
     ...
     if request.method == 'POST':
        ...
        vcategory=request.POST.get('category')
        vimage=request.POST.get('image')
        obj=Product(name=vname,price=vprice,description=vdescription,image=vimage)
        obj.save()
